...
Scheme
{
	...
	Colors
	{
		...
		"BrightControlText"	"0 160 255 255"	// use for selected controls
		...
		// background colors
		"ControlBG"			"68 68 68 200"		// background color of controls
		"ControlDarkBG"		"86 86 86 200"		// darker background color; used for background of scrollbars
		"WindowBG"			"50 50 50 200"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"126 187 255 255"	// background color of any selected text or menu item
		"SelectionBG2"		"40 40 40 200"		// selection background in window w/o focus
		"ListBG"			"0 77 181 255"		// background of server browser, buddy list, etc.
